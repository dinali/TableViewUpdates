...
/* need to finish copy & pasting the code from TableViewController */
...
*/
/*
@synthesize sectionInfoArray=sectionInfoArray_, quoteCell=newsCell_, pinchedIndexPath=pinchedIndexPath_, uniformRowHeight=rowHeight_, openSectionIndex=openSectionIndex_, initialPinchHeight=initialPinchHeight_;
 */
...
- (void)viewDidLoad {
     ...
     */
  // TODO  rowHeight_ = DEFAULT_ROW_HEIGHT;
...
- (void)viewWillAppear:(BOOL)animated {
	...
	if ((self.sectionInfoArray == nil) || ([self.sectionInfoArray count] != [self numberOfSectionsInTableView:self.tableView])) {
        ...
        /* -- FIX THIS BY CHANGING REFERENCES
...
-(NSInteger)tableView:(UITableView*)tableView numberOfRowsInSection:(NSInteger)section {
	...
	// TODO: NSInteger numStoriesInSection = [[sectionInfo.play quotations] count];
	
    // TODO return sectionInfo.open ? numStoriesInSection : 0;
}


-(UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath {
    
    static NSString *QuoteCellIdentifier = @"PublicationCellIdentifier";
    
    PublicationCell *cell = (PublicationCell*)[tableView dequeueReusableCellWithIdentifier:QuoteCellIdentifier];
    
    if (!cell) {
        
        UINib *quoteCellNib = [UINib nibWithNibName:@"PublicationCell" bundle:nil];
        [quoteCellNib instantiateWithOwner:self options:nil];
        cell = self.publicationCell;
        self.publicationCell = nil;
    ...
    cell.category = [category.publications objectAtIndex:indexPath.row];
    */
    return cell;
}
